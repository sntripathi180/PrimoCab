...
// use debounce like lodalash.debounce to limit api call
  ...
  const handleDestinationChange = async (e) => {
    ...
    try {
      ...
      console.error("something went wrong in handling destination suggestion",error)
    }
  }
  ...
  return (
    <div className="h-screen relative overflow-hidden">
      ...
      <div className="flex flex-col justify-end h-screen absolute top-0  w-full">
        <div className="h-[30%] p-5 bg-white relative">
          <h4
            ...
            className="opacity-0 absolute top-6 right-4 text-2xl"
          >
      ...
      <div
        ref={vehiclePanelRef}
        className="fixed  w-full z-10 bottom-0  px-3 translate-y-full py-8 bg-white pt-9"
      >
        <VehiclePanel
